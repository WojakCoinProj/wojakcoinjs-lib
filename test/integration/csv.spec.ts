...
import { reverseBuffer } from 'wojakcoinjs-lib/src/bufferutils';
...
describe('wojakcoinjs-lib (transactions w/ CSV)', () => {
  // force update MTP
  before(async () => {
  ...
  // Note: wojakcoinjs-lib will not offer specific support for problems with
